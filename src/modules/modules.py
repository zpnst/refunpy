...
'''
    ...
    mkchcall[{{'fcall', s.fnm1, {e.args1}}, {'fcall', s.fnm2, {e.args2}}, e.oth}] =\
        mkchcall[{{'fcall', s.fnm2, {{{'fcall', s.fnm1, {e.args1}}}, e.args2}}, e.oth}]
        
    mkchcall[{{'fcall', s.fnm1, {e.args1}}, {'fcall', s.fnm2, {e.args2}}}] =\
    ...
    mkcomv[{{e.ty, s.var}, e.oth}, {{{'fcall', e.fc}}, e.oexp}, e.state] =\
        mkcomv[{{e.ty, s.var}, e.oth}, join[wrap[expr[{{'fcall', e.fc}}, e.state], 2], {e.oexp}], e.state]
...
'''
    ...
    expr[{{'fcall', s.fnm, {e.args}}, e.oth}, {e.g, 'funcs', {e.f}}, 
        {e.e1, {'func', {s.fnm, t.s, t.a, t.r}, t.b}, e.e2}] =\
            unpack[expr[mkchcall[{{'fcall', s.fnm, {e.args}}, e.oth}], 
